...
public class TestReportExcel_2007XL {
    ...
    public void testBigReport() throws Exception  {
        ...
        Body bd = Excel_2007XL.instanceBody(
        new Excel_2007XL.Header() {
        ...
        FileOutputStream out = new FileOutputStream("target/bigReport_07XL.xlsx");
        wb.write(out);
        out.close();
    }
    ...
    public void testColorReport() throws Exception {
        ...
        new Excel_2007XL.Header() {
            public void prepareHeader() {
                ...
                //
                .addNewRow()
                    .addAndConfigureCells(new INewCell<Cell07XL<Header>>() {
                        private int i = 0;

                        public void iCell(final Cell07XL<Header> newCell) {
        ...
        final FileOutputStream fout = new FileOutputStream("target/colorReport_07XL.xlsx");
        wb.write(fout);
        fout.close();
    }
}
